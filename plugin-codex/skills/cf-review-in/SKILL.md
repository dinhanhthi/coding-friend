...
Run: `bash "${PLUGIN_ROOT}/lib/load-custom-guide.sh" cf-review-in`
...
### Step 3: Validate and parse each result file
...
### Step 6: Present the verified results
...
### Step 7: Smart capture (conditional — only if `memory_store` MCP tool is available)
...
### Step 8: Completion banner and next steps
