...
>
> **Diff:** obtain it with `bash "${PLUGIN_ROOT}/skills/cf-review/scripts/gather-diff.sh"` (default target — covers staged, unstaged, and untracked files) or, for a file / commit-range target, the exact `git diff <range> -- <path>` command.
>
> **Changed files:**
> [paths from Step 5]
>
