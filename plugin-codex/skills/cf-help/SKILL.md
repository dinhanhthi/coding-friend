...
2. Anything more specific → Read `${PLUGIN_ROOT}/skills/cf-help/topics.md` (or `plugin/skills/cf-help/topics.md` in this repo) — topic → source map, flags, hooks, CLI, config.
...
Follow the lookup rule. Typical paths (plugin root = `${PLUGIN_ROOT}`):
