...
- **cf-reviewer** — ⚡ — Orchestrator: **cf-reviewer-plan** (medium reasoning effort), **cf-reviewer-security** (medium reasoning effort), **cf-reviewer-quality** (low reasoning effort), **cf-reviewer-tests** (low reasoning effort), **cf-reviewer-rules** (low reasoning effort), **cf-reviewer-reducer** (low reasoning effort)
