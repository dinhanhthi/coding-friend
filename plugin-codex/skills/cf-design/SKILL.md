...
Run: `bash "${PLUGIN_ROOT}/lib/load-custom-guide.sh" cf-design`
...
Run: `bash "${PLUGIN_ROOT}/skills/cf-design/scripts/load-design-context.sh"`
...
2. **Read the design styles reference** to calibrate what you're looking for:
   ...
   ```
   Read: ${PLUGIN_ROOT}/skills/cf-design/scripts/design-styles.md
   ```
...
1. **Read design principles**:
   ...
   ```
   Read: ${PLUGIN_ROOT}/skills/cf-design/scripts/design-principles.md
   ```
