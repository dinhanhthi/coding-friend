...
- Fix `cf init` missing `docs/context/` in the `.gitignore` block it writes — context files generated by `cf-explorer`, `cf-planner`, and `cf-implementer` were not ignored [#1283896](https://github.com/dinhanhthi/coding-friend/commit/1283896)
- Remove `node -e *` from the `auto-approve` hook permission allow list — the pattern was overly broad [#2a730a0](https://github.com/dinhanhthi/coding-friend/commit/2a730a0)
