...
```!
bash "${AGY_PLUGIN_ROOT}/lib/load-custom-guide.sh" cf-review
```
...
```bash
bash "${AGY_PLUGIN_ROOT}/skills/cf-review/scripts/run-codex-review.sh" "${CF_DOCS_ROOT}/reviews/<label>-result-codex.md"
```
...
```bash
bash "${AGY_PLUGIN_ROOT}/skills/cf-review/scripts/run-agent-review.sh" <agent> "${CF_DOCS_ROOT}/reviews/<label>-result-<agent>.md"
```
...
```bash
bash "${AGY_PLUGIN_ROOT}/skills/cf-review/scripts/assess-changes.sh"
```
...
3. Normalize the raw Codex result into the standard 4-section format:
   ...
   ```bash
   bash "${AGY_PLUGIN_ROOT}/skills/cf-review/scripts/normalize-codex-review.sh" "${CF_DOCS_ROOT}/reviews/<label>-result-codex.md"
   ```
...
```bash
bash "${AGY_PLUGIN_ROOT}/skills/cf-review/scripts/mark-reviewed.sh"
```
