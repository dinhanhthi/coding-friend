...
1. **Run review** — invoke the cf-review skill (activate the `cf-review` skill (type `/cf-review`), no extra args). cf-review will analyze uncommitted changes. Count this as review round 1.
