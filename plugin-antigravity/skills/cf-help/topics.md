...
Paths are relative to `<plugin-root>` (git checkout: `plugin/`). Repo-only `docs/…` are **not** shipped in the plugin.
...
| `cf-reviewer-rules`    | haiku   | direct call only (AGENTS.md MUST/SHOULD/ALWAYS/NEVER)                      |
