...
```!
bash "${AGY_PLUGIN_ROOT}/lib/load-custom-guide.sh" cf-research
```
...
> Format: use the Research Part Template (read it from ${AGY_PLUGIN_ROOT}/skills/cf-research/references/templates.md before writing).
...
See `${AGY_PLUGIN_ROOT}/skills/cf-research/references/templates.md` for the full Research Part Template, Quick Reference Notes Template, and Summary Template. The subagent should read that file before writing.
