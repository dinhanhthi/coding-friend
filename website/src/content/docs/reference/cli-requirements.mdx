...
| ------------------------------------------------------ | -------- | -------------------------- | -------------------------------- |
| [cf-advise](/docs/skills/cf-advise/)                   | OPTIONAL | Fast indexed memory search (only the `--save` flow) | `grep -r '<query>' docs/memory/` |
...
| [cf-later-do](/docs/skills/cf-later-do/)               | NONE     | —                          | —                                |
