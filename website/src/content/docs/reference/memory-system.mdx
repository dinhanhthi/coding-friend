...
:::note
The Tier 2 daemon (`cf memory start`) includes a file watcher that auto-rebuilds on markdown changes. But in Tier 1 (SQLite via MCP), there is no watcher — you must rebuild manually.
:::
