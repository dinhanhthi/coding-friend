...
Run `cf mcp` to print the configuration snippet for both Learn MCP and Memory MCP. To get only the Memory MCP config, run `cf memory mcp`.

Add the output to your MCP client config:
