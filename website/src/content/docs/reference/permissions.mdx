...
These rules are needed because [`/cf-learn`](/docs/skills/cf-learn/) always writes to a global directory outside your project (default: `~/.coding-friend/learn/`). They are generated dynamically based on your configured `learn.outputDir` path.
