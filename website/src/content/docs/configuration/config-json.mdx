...
Separate from `config.json`, you can extend built-in skills with project-specific guidance. See [Custom Skill Guides](/configuration/custom-skill-guides) for full documentation and examples.
