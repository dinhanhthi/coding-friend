...
Set the root directory for all documentation (default: `docs`). All skill output folders are relative to this: `plans/`, `memory/`, `research/`, `learn/`, and `sessions/`.
...
- `language`: Language for `/cf-learn` notes (default: falls back to top-level `language`, then `"en"`)
