...
- **Antigravity** — plugin version and enabled/disabled state when the plugin is installed at `~/.gemini/config/plugins/coding-friend/` (`not installed` otherwise)
...
🔧 Plugin
  ...
  Antigravity  v0.41.0 enabled  ~/.gemini/config/plugins/coding-friend/
