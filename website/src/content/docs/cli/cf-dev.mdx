...
- `cf dev update` - Update local dev plugin to latest version (off + on). Use this when you have new local changes (e.g. after a version bump) and want to update the cached plugin to the latest version.
