...
6. **Implement** — Dispatches the [`cf-implementer`](/docs/reference/agents/#cf-implementer) agent with strict [TDD discipline](/docs/skills/cf-tdd/): verify existing tests pass, implement the optimization, confirm no regressions
