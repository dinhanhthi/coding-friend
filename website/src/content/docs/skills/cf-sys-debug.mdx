...
The `cf-sys-debug` skill activates when you're debugging issues. It guides you through a structured 5-phase process: Root Cause Investigation, Pattern Analysis, Hypothesis Testing, Implementation, Document.
