...
💡 To see what you've learned so far, run [`cf host`](/docs/cli/cf-host/) to view the learning notes in your browser or use [`cf mcp`](/docs/cli/cf-mcp/) to integrate with other LLM clients.
