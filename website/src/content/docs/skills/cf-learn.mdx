...
The topic name for the output file is always **auto-detected** from the content, not taken verbatim from your argument. Your argument narrows *what* to extract, not *what to name the file*.
