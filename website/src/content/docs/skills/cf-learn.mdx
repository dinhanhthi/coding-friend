...
💡 Looking for a deeper, conversational breakdown of *what happened and why* during a task? Check out [`/cf-teach`](/docs/skills/cf-teach/) — it explains everything like a sharp friend over coffee, covering approach, alternatives, tradeoffs, mistakes, and transferable lessons.
