...
For example, `.coding-friend/skills/cf-commit.md` can add custom commit rules or trigger `/changelog` after each commit. See [Configuration](/docs/configuration/config-json#custom-skill-guides) for full details.
