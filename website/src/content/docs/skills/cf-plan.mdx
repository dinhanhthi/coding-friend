...
- Create a phased implementation plan (with rollback fields per task in hard mode)
- Save the plan to `docs/plans/2026-03-05-rest-api-auth-plan.md`
- Offer to implement it task by task (with review gates every 2–3 tasks in hard mode)
