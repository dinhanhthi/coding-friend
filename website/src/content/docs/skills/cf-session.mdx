...
This folder is created by `cf init` alongside `docs/plans/`, `docs/memory/`, and `docs/research/`. It is added to `.gitignore` during `cf init` if you choose to ignore docs artifacts.
