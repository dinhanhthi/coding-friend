...
4. **Dispatch to orchestrator** — Fork a [`cf-reviewer`](/docs/reference/agents/#cf-reviewer-orchestrator) orchestrator agent in an isolated context (clean, unbiased, token-efficient)
