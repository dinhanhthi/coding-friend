...
5. **Apply 4-layer review** — Quality, security, testing, and design analysis (via [`cf-auto-review`](/docs/skills/cf-auto-review/))
...
After the 4-layer review, `/cf-review` automatically invokes Claude Code's built-in [`/security-review`](https://github.com/anthropics/claude-code-security-review) — a dedicated security audit skill from Anthropic. This means every `/cf-review` run gets **two layers of security analysis**:

| Pass                   | Source                                                                                    | Focus                                                            |
| ---------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| **Layer 3**            | Coding Friend's 4-layer review                                                           | Injection, auth bypasses, secrets, data flow — confidence-scored |
