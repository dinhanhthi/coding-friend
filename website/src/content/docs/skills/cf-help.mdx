---
title: "/cf-help"
description: "Answer questions about Coding Friend — skills, agents, workflows, setup. Also auto-invoked."
keywords: [help, overview, skills, agents, workflows, setup, auto-invoked]
---
...
For a full list of common issues (installation, hooks, memory daemon, MCP, CLI), see the [Troubleshooting reference](/docs/reference/troubleshooting/).
