...
9. **Review Reminder** — Asks if you want to run [`/cf-review`](/docs/skills/cf-review/) or [`/cf-commit`](/docs/skills/cf-commit/)
...
After the fix is verified, follow this order:

```
/cf-fix → /cf-review → /cf-commit
```
