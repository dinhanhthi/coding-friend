...
The `/cf-remember` skill captures important project knowledge and saves it for future reference in `docs/memory/`. In subsequent sessions, the AI can read and apply this knowledge, accelerating work.
