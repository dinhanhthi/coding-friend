...
keywords: [code review, review methodology, checklist]
---

The `cf-auto-review` skill activates during code review phases. It applies a comprehensive multi-layer checklist examining correctness, security, performance, maintainability, and test coverage.
