...
- (Optional) Codex CLI if you use codex. It's useful for cross-review with [`/cf-review --with-codex`](/docs/skills/cf-review/).
...
If you prefer to install **without the CLI** (you will lose almost 50% the power of CF, see [CLI Requirements](/docs/reference/cli-requirements/) for more), you can add the marketplace and install the plugin manually:
