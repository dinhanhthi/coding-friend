      ...
      <div className="flex h-14 items-center justify-between">
        ...
        <div className="flex items-center gap-1 md:gap-3">
          ...
          <a
            ...
            className="hidden cursor-pointer rounded-lg p-2 text-slate-400 transition-colors duration-200 hover:text-white md:flex"
            aria-label="GitHub"
          >
        ...
        <nav className="space-y-1 border-t border-[#a0a0a01c] py-4 md:hidden">
          ...
          <div className="flex items-center gap-3 px-3 py-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex cursor-pointer items-center gap-2 text-sm font-medium text-slate-400 hover:text-violet-400"
            >
