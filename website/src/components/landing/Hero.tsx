      ...
      <Container className="relative">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-4 text-base font-medium tracking-wider text-slate-500 uppercase">
            Claude Code + Codex CLI + omp + Antigravity (beta)
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-base">
            ...
            <span className="text-slate-600">+</span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-sky-500/30 bg-sky-500/10 px-3 py-1 font-mono text-sky-300">
              Antigravity
              <span className="rounded-full bg-sky-400/20 px-1.5 text-[0.65em] font-semibold tracking-wide text-sky-200 uppercase">
                beta
              </span>
            </span>
            <span className="text-slate-600">+</span>
