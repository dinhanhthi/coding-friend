...
- Replace `docs/plugin-dev.md` with a simplified `CONTRIBUTING.md` covering how local dev resolves `${CLAUDE_PLUGIN_ROOT}` and what to do after each change [#65c1cf4c](https://github.com/dinhanhthi/coding-friend/commit/65c1cf4c)
