...
2. Anything more specific → Read `${CLAUDE_PLUGIN_ROOT}/skills/cf-help/topics.md` (or `plugin/skills/cf-help/topics.md` in this repo) — topic → source map, flags, hooks, CLI, config.
