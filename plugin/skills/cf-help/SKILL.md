...
- **cf-reviewer** — ⚡ — Reviews the diff itself, 5 layers. `/cf-review` dispatches it directly: 1 in QUICK, 1 in STANDARD, 2 in DEEP — the second is **cf-reviewer-security** (sonnet). Flat graph — no sub-dispatch, no merge agent.
